...
import { getPenilaianBimbingan, getPenilaianLaporanByDosen, postPenilaianBimbingan, postPenilaianLaporanByDosen, putPenilaianBimbingan, putPenilaianLaporanByDosen } from '@/utils/penilaian';
...
const Penilaian = () => {
    ...
    return (
        <>
            ...
            <Tabs variant='outline' defaultValue="bimbingan">
                <Tabs.List>
                    <Tabs.Tab value="bimbingan" leftSection={<IconReportAnalytics width={15} />}>
                        Bimbingan
                    </Tabs.Tab>
