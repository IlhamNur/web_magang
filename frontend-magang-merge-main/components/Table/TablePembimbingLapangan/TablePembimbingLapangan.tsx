...
import { IconSelectAll, IconZoomReplace } from '@tabler/icons-react';
...
const TablePembimbingLapangan = ({ records, loading, fetchData, dataMahasiswa, dataMahasiswaFull }: { records: RecordPemlap[], loading: boolean, fetchData: () => void, dataMahasiswa: { value: string; label: string; }[], dataMahasiswaFull: [] }) => {
                    ...
                    render: (record) => (
                        <Group gap={4} justify="right" wrap="nowrap">
                            ...
                            {/* <ActionIcon
                                ...
                                color="orange"
                                onClick={() => {
                                    showModal({ record, action: 'change', fetchData })
                                }}
                                title='Ganti'
                            >
