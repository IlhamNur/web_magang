...
import { ActionIcon, Box, Button, Group, NumberInput, Stack, Text, Textarea, TextInput } from '@mantine/core'
...
const TableKegiatanHarian = ({ records, isLoading, fetchData }: { records: RecordKegiatanHarian[], isLoading: boolean, fetchData: () => void }) => {
