...
const TableUnitKerja = ({ records, loading, fetchData, dataProvinsi }: { records: RecordUnitKerja[], loading: boolean, fetchData: () => void, dataProvinsi: any }) => {
    // pagination
                    ...
                    render: (record) => (
                        <Group gap={4} justify="right" wrap="nowrap">
                            ...
                            <ActionIcon
                                ...
                                color="blue"
                                onClick={() => {
                                    showModal({ record, action: 'edit', fetchData, dataProvinsi })
                                }}
                                title='Ubah'
                            >
                                <IconEdit size={16} />
